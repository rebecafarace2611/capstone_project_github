...
# 5. Print table
print("\n" + "="*45)
print("TUNED XGBOOST — FINAL TEST METRICS")
print("="*45)
rows = [
    ("Threshold (q*)", q_star),
    ("Precision",      precision),
...
pd.DataFrame(rows, columns=["metric", "xgboost_tuned"]).to_csv(
    "xgboost_tuned_metrics.csv", index=False)
print("\nSaved: xgboost_tuned_metrics.csv")

# Python classification report (matching Prof Juan's requested format)
print("\n" + "="*50)
